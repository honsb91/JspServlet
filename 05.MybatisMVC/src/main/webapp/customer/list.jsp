					...
					<c:otherwise>
						...
						<c:forEach items="${list}" var="vo" varStatus="i">
							<tr>
								...
								<td>${vo.email}</td>
								<td>${vo.phone}</td>
								<td><a onclick="updateCus(${i.index+1}, ${vo.customer_id});" class="btn btn-dark">수정</a></td>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="insertModalLabel">고객추가</h5>
